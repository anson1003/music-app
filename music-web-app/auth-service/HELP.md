...
* [Spring Boot DevTools](https://docs.spring.io/spring-boot/docs/2.7.14.RELEASE/reference/htmlsingle/index.html#using.devtools)
* [Spring Web](https://docs.spring.io/spring-boot/docs/2.7.14.RELEASE/reference/htmlsingle/index.html#web)
